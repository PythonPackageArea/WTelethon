...
async def ensure_web_login(
    reciepient_client: "TelegramClient", donor_client: "TelegramClient"
) -> bool:
    ...
    await reciepient_client.accept_web_login_token(
        *utils.parse_url_auth(url_auth_result.url)
    )
